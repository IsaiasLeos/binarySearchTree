...
public class bst_ops {
    ...
    /**
     * A form of traversing the Binary Search Tree Iterative Version Eg.
     * 1,2,3,4,5
     *
     * @param T
     */
    public static void inOrderWithoutRecursion(bstNode T) {
        ...
        {
            if (root != null) {//not empty push the left side to the stack
                stack.push(root);
                root = root.left;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Array1.length; i++) {//insert nodes into tree
